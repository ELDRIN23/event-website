...
### 🚫 Prohibited Actions & Strict Terms of Use

By accessing or viewing this repository, you agree to adhere to the following restrictions:

1. **No Reproduction or Copying:** You may not copy, clone, scrape, duplicate, or store any portion of this codebase into public or private repositories, local storage, or cloud drives for reuse.
2. **No Commercial or Non-Commercial Reuse:** No part of this web application may be deployed, resold, sublicensed, hosted, or used in personal, client, or commercial projects without prior written consent from the author.
3. **No Derivative Works:** You may not modify, alter, reverse-engineer, or build derivative products based on the design, layout, or logic written in this project.
4. **No Asset Theft:** Custom icons, styling systems, interactive components, and graphical layouts are strictly protected and may not be extracted or reused.

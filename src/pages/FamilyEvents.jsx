...
import { Gem, ArrowLeft, PartyPopper } from "lucide-react";
      ...
      <section className="py-12 px-6 md:px-16 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <p className="uppercase tracking-[4px] text-slate-500 text-xs font-semibold mb-2 flex items-center justify-center gap-1.5">
            <PartyPopper size={14} className="text-amber-600" /> Event Themes
          </p>
          <h2 className="text-3xl md:text-5xl font-serif text-slate-900">Choose Your Celebration</h2>
        </div>
          ...
          {events.map((event, index) => (
            ...
            >
              ...
              <div className="p-8 flex flex-col flex-grow justify-between">
                ...
                <Link to={event.route} className="block mt-auto">
